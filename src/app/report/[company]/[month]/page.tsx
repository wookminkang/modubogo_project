          ...
          <div className="flex items-stretch">
            ...
            <div className="flex items-center justify-between flex-1">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {uniqueAgencies}
                  <span className="text-base font-normal text-gray-500 ml-1">곳</span>
                </p>
              </div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6"/></svg>
            </div>
          </div>

          {/* 안내 문구 */}
          <div className="mt-4 flex items-start gap-1.5 bg-gray-50 rounded-xl px-3 py-2.5">
            <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-0.5 flex-shrink-0"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
            <p className="text-xs text-gray-400 leading-relaxed">해당 금액은 전체 외주업체의 광고비 합계입니다.</p>
          </div>
        </div>
