...
import { unitLabel, type TeamLeaveItem } from "@/app/employee/team-calendar/team-calendar-types";
...
/**
 * 관리자용 전 직원 휴가 월 캘린더 (읽기 전용, 서버 컴포넌트).
 * employee/team-calendar 의 (삭제된) TeamLeaveCalendar.tsx 와 동일한 주 단위 연속 막대 방식을
 * 그대로 재사용 — "나"(currentEmployeeId) 하이라이트만 관리자 화면이라 의미가 없어 뺐다.
 */
